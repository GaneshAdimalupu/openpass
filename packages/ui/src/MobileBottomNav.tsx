...
const navItems = [
  ...
  { icon: 'person', label: 'Profile', href: '/me' },
]
...
export function MobileBottomNav() {
  ...
  return (
    ...
    <nav className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[92%] z-50 flex justify-around items-center h-16 px-4 bg-[#25343F]/80 backdrop-blur-xl border border-white/10 rounded-full shadow-[0_20px_40px_rgba(0,0,0,0.6)]">
