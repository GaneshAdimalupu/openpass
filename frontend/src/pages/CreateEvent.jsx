...
export default function CreateEvent() {
  ...
  const [tickets, setTickets] = useState([
    { name: "General", price: 0, total_quantity: "" },
  ]);
  ...
  return (
    ...
    >
      ...
      <main
        style={{ maxWidth: "680px", margin: "0 auto", padding: "60px 40px" }}
      >
        <h1
          style={{
            fontSize: "32px",
          ...
          {[1, 2].map((s) => (
            <div
              ...
              style={{
                ...
                flex: 1,
                borderRadius: "100px",
                background: s <= step ? "#e8ff47" : "#1a1a2e",
              }}
            />
          ))}
        </div>
        ...
        {step === 1 ? (
          <form onSubmit={handleNext}>
            <Field
              ...
              value={form.title}
              onChange={(v) =>
                setForm({ ...form, title: v, slug: autoSlug(v) })
              }
              placeholder="DevFest Kerala 2025"
            />
            ...
            <Field
              ...
              placeholder="Technopark, Trivandrum"
            />
            <div
              style={{
                display: "grid",
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const n = [...tickets];
                        n[i].total_quantity = e.target.value;
                        setTickets(n);
                      }}
                      style={inputStyle}
                      placeholder="∞"
